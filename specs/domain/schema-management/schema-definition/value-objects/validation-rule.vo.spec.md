...
#### `ValidationRule.custom(name: string, type: ValidationRuleType, displayName: string, validator: (value: unknown, params: ValidationRuleParameter[]) => boolean): ValidationRule`
