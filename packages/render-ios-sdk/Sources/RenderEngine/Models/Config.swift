...
/// Configuration wrapper for component properties and data
public class Config {
    private let config: [String: Any?]

    public init(_ config: Any? = nil) {
    ...
    public func get<T>(forKey key: String, type: T.Type) -> T? {
        switch type {
        case is String.Type:
    ...
    public func getInt(forKey key: String, defaultValue: Int? = nil) -> Int? {
        let value = key.contains(".") ? resolveNestedKey(key) : config[key]
    ...
    public func getFloat(forKey key: String, defaultValue: Float? = nil) -> Float? {
    ...
    public func getDouble(forKey key: String, defaultValue: Double? = nil) -> Double? {
        if let value = config[key] as? Int {
            return Double(value)
        }
        if let value = config[key] as? Float {
    ...
    public func getCGFloat(forKey key: String, defaultValue: CGFloat? = nil) -> CGFloat? {
        let value = key.contains(".") ? resolveNestedKey(key) : config[key]
        if let intValue = value as? Int {
    ...
    public func getBool(forKey key: String, defaultValue: Bool? = nil) -> Bool? {
    ...
    public func getDate(forKey key: String, defaultValue: Date? = nil) -> Date? {
    ...
    public func getArray(forKey key: String, defaultValue: [Any] = []) -> [Any] {
    ...
    public func getConfigArray(forKey key: String, defaultValue: [Config] = []) -> [Config] {
        if let value = config[key], let array = value as? [Any] {
    ...
    public func getDictionary(forKey key: String, defaultValue: [String: Any]? = nil) -> [String: Any]? {
        let value = key.contains(".") ? resolveNestedKey(key) : config[key]
    ...
    public func getConfig(forKey key: String) -> Config {
    ...
    public func merge(_ other: Config, deep: Bool = false) -> Config {
