...
export const CartScreen = () => (
  <Column style={{ width: '100%', height: '100%', backgroundColor: '#FFFFFF' }}>
    ...
    {/* Select All Section */}
    <Row style={{ justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12 }}>
...
const SellerSection = ({ storeName, rating, reviewCount, checked }: any) => (
...
const CartItem = ({ image, price, title, quantity, checked }: any) => (
...
const BundleSection = () => (
  <Column style={{ paddingHorizontal: 16, paddingVertical: 20, gap: 16 }}>
    ...
    <Row style={{ gap: 16 }}>
      {/* Recommended Item 1 */}
      <BundleItem image="watch.png" currentPrice="26 591 ₽" originalPrice="27 990 ₽" title="Apple Watch 10 42mm Blue" />
...
const BundleItem = ({ image, currentPrice, originalPrice, title }: any) => (
